...
public enum DesignSystem {
    public enum Colors {
        public static let focus = Color(red: 1.0, green: 0.58, blue: 0.0)
        public static let shortBreak = Color(red: 0.19, green: 0.84, blue: 0.78)
        public static let longBreak = Color(red: 0.35, green: 0.34, blue: 0.84)
    }
    ...
    public enum Spacing {
        ...
        public static let headerTop: CGFloat = 44
        public static let headerSideInset: CGFloat = 36
        public static let timeTop: CGFloat = 160
        public static let timeRightPadding: CGFloat = 36
        public static let timeLeftInset: CGFloat = 24
        public static let buttonBottom: CGFloat = 56
        public static let timelineBottom: CGFloat = 14
        public static let timelineSideInset: CGFloat = 24
        public static let timelineGap: CGFloat = 3
    ...
    public enum Opacity {
        public static let phaseLabelColor: Double = 0.7
        public static let textMuted: Double = 0.45
        public static let grainOverlay: Double = 0.04
        public static let timelineActive: Double = 1.0
        public static let timelineCompleted: Double = 0.4
        public static let timelineUpcoming: Double = 0.15
        public static let timelineProgress: Double = 0.3
        public static let buttonBackground: Double = 0.10
        public static let underlineAccent: Double = 0.55
    }
